...
public class Update_employee extends JFrame implements ActionListener,ItemListener{
    ...
    Update_employee(){
        ...
        try{
            //Collect all the employee ID and add to options
            conn c = new conn();
    ...
    public void actionPerformed(ActionEvent ae){
        //Update the data according to the input
        if(ae.getSource()==b1){
            String n = t1.getText();
        ...
        if(ae.getSource()==b2){
            // Delete the employee according to the choosen ID
            try{
                conn c1 = new conn();
    ...
    public void itemStateChanged(ItemEvent ie){
        try{
            // show the data relate to the choosen employee ID
            conn c1 = new conn();
